...
{
    public partial class ucKorisniciUredi : UserControl
    {
        ...
        public ucKorisniciUredi(int ID)
        {
            _ID = ID;
            InitializeComponent();
        }

        private async void ucKorisniciUredi_Load(object sender, EventArgs e)
        {
        ...
        private async void btnSacuvaj_Click(object sender, EventArgs e)
        {
            ...
            if (ValidateChildren())
            {
                try
                {
                    ...
                    MessageBox.Show("Uspješno ste izmijenili podatke o korisniku");
